...
import {
    HelloDetails,
    WampCallOptions, WampCancelOptions, WampEventOptions, WampInvocationOptions,
    WampPublishOptions,
...
export namespace WampRaw {
    ...
    export type Event = [WampType.EVENT, WampId, WampId, WampEventOptions, WampArray, WampObject];
    export type Result = [WampType.RESULT, WampId, WampResultOptions, WampArray, WampObject];
    export type Registered = [WampType.REGISTERED, WampId, WampId];
    export type Unregistered = [WampType.UNREGISTERED, WampId];
    export type Invocation = [WampType.INVOCATION, WampId, WampId, WampInvocationOptions, WampArray, WampObject];
